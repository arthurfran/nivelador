  ...
  return (
    <View style={{ alignItems: "center" }}>
      <Svg width={size} height={size} viewBox="0 0 423.833 423.833">
        ...
        {/* contorno/ícone original */}
        <Path d={pathCaixa} fill="#cbd5e1" />

        {/* realce */}
        <Path d={pathCaixa} fill="none" stroke="#475569" strokeWidth="4" />
      </Svg>
    </View>
  );
}
